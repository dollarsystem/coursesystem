...
public class CreateUserHandler {
	public static void onHandle(CreateUserRequest p_request)
	{
		...
		try
		{
			...
			{
				if(Database.getStudent(p_request.m_student.m_id)!=null)
					throw new IllegalArgumentException("该帐号学生已存在！");
			...
			{
				if(Database.getTeacher(p_request.m_teacher.m_id)!=null)
					throw new IllegalArgumentException("该帐号老师已存在！");
			...
			{
				if(Database.getDean(p_request.m_dean.m_id)!=null)
					throw new IllegalArgumentException("该帐号院系教务员已存在！");
				Dean u=new Dean();
			...
			{
				if(Database.getProvest(p_request.m_provest.m_id)!=null)
					throw new IllegalArgumentException("该帐号教务处老师已存在！");
