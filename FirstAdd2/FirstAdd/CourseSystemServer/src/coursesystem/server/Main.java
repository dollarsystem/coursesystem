...
import coursesystem.server.handler.CreateUserHandler;
import coursesystem.server.handler.ManagerInfosHandler;
...
public class Main
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		SmartEvents.bind(ManagerInfosRequest.class,ManagerInfosHandler.class,"onHandle");
		...
		SmartEvents.bind(CreateUserRequest.class, CreateUserHandler.class, "onHandle");
